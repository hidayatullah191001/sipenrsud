      ...
      <div class="card-body">
        ...
        <form class="forms-sample" method="post">
          <div class="form-group">
            ...
            <input type="date" class="form-control" value="<?=$parkir['tgl_setor'] ?>" id="tgl_setor" name="tgl_setor">
            <?= form_error('tgl_setor', '<small class="text-danger">', '</small>') ?>
          </div>
          <div class="form-group">
           <label for="tgl_setoran">Tanggal Setor</label>
           <input type="date" class="form-control" id="tgl_setoran" value="<?=$parkir['tgl_setoran'] ?>" name="tgl_setoran">
           <?= form_error('tgl_setoran', '<small class="text-danger">', '</small>') ?>
         </div>
         <div class="form-group">
          <label for="jumlah_setoran">Jumlah Setoran</label>
          <input type="text" class="form-control" id="dengan-rupiah" value="<?=$parkir['jumlah_setoran'] ?>" name="jumlah_setoran" placeholder="Masukkan jumlah setoran ....">
