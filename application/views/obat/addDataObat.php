    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" id="tgl_penjualan" name="tgl_penjualan" value="<?=set_value('tgl_penjualan') ?>">
          <?= form_error('tgl_penjualan', '<small class="text-danger">', '</small>') ?>
        </div>
        <div class="form-group">
          <label for="jumlah">Jumlah</label>
          <input type="text" class="form-control" id="dengan-rupiah" name="jumlah" placeholder="Masukkan jumlah..." value="<?=set_value('jumlah') ?>">
